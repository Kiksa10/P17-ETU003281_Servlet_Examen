...
set MYSQL_API_JAR=%LIB_DIR%\mysql-connector-j-9.1.0.jar
set OJDBC_API_JAR=%LIB_DIR%\ojdbc6.jar
...
javac -cp %SERVLET_API_JAR%;%MYSQL_API_JAR%;%OJDBC_API_JAR% -d %BUILD_DIR%\WEB-INF\classes @sources.txt
del sources.txt
